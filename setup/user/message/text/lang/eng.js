...
❏ *_Wait until 12:00 AM (Europe/Berlin)_*
    `
}

exports.gptlimitReset = () => {
    return `GPT limit has been reset successfully!`
}

exports.gptlimitResetAll = () => {
    return `All GPT limits have been reset successfully!`
}

exports.limitReset = () => {
    return `Limit has been reset successfully!`
}

exports.limitResetAll = () => {
    return `All limits have been reset successfully!`
}

exports.welcomeSet = () => {
    return `Custom welcome message was set successfully!`
}

exports.extractMediaOnly = () => {
    return `Only media can be reposted!`
}

exports.nsfwNotEnabled = () => {
    return `NSFW mode is not enabled for this group! Please enable NSFW mode using *${prefix}nsfwon*!`;
}

exports.rbNotEnabled = () => {
    return `Realbooru is not enabled for this group! Please enable Realbooru using *${prefix}rbon*!`;
}
...
Type *${prefix}menu* index_number or index_name to open the selected page menu.
    `
}
...
15. *${prefix}gptlimit*
Check your remaining gpt limit.
Aliases: -
Usage: *${prefix}gptlimit*
...
Bass boost.
Aliases: -
Usage: Reply audio/voice with caption *${prefix}bass*.
...
Repost media.
Aliases: *re*
Usage: Reply media with caption *${prefix}repost*
...
Add users to group.
Aliases: -
Usage: *${prefix}add* 49xxxxxxxxxxx
...
9. *${prefix}welcome*
Toogle welcome feature, or set your custom welcome message.
Aliases: -
Usage: *${prefix}welcome* enable/disable/set
...
16. *${prefix}levelingmedia*
Toogle levelingmedia feature.
Aliases: *levelmedia* *lvlmedia*
Usage: *${prefix}levelingmedia* enable/disable
...
Aliases: -
Usage: *${prefix}ban* add/del @user/49xxxxxxxxxxx
...
*d* - days
Aliases: -
Usage: *${prefix}premium* add/del @user/49xxxxxxxxxxx 30d
...
Block user.
Aliases: *blok*
Usage: *${prefix}block* @user/49xxxxxxxxxxx

15. *${prefix}unblock*
Unblock user.
Aliases: *unblok*
Usage: *${prefix}unblock* @user/49xxxxxxxxxxx
...
17. *${prefix}limitreset*
Reset Limit.
Aliases: *limitres*
Usage: *${prefix}limitreset* all/@user/49xxxxxxxxxxx

18. *${prefix}gptreset*
Reset GPT Limit.
Aliases: *gptres*
Usage: *${prefix}gptreset* all/@user/49xxxxxxxxxxx
...
2. *${prefix}zorg*
ChatGPT 3.5 ZORG jailbreak.
Aliases: *zorg*
Usage: *${prefix}zorg* your_question
...
4. *${prefix}thispersondoesnotexist*
Send random image from thispersondoesnotexist.
Aliases: *tpdne*
Usage: *${prefix}thispersondoesnotexist*
...
1. *${prefix}nsfwon*
Enable nsfw in the group.
Aliases: -
Usage: *${prefix}nsfwon*

2. *${prefix}nsfwoff*
Disable nsfw in the group.
Aliases: -
Usage: *${prefix}nsfwoff*

3. *${prefix}lolion*
Enable gelbooru loli tag search in the group.
Aliases: -
Usage: *${prefix}lolion*

4. *${prefix}lolioff*
Disable gelbooru loli tag search in the group.
Aliases: -
Usage: *${prefix}lolioff*

5. *${prefix}rbon*
Enable realbooru in the group.
Aliases: -
Usage: *${prefix}rbon*

6. *${prefix}rboff*
Disable realbooru in the group.
Aliases: -
Usage: *${prefix}rboff*
...
8. *${prefix}rule34*
Send rule34 media by specified tags.
Aliases: *r34*
Usage: *${prefix}rule34* tag1 tag2 tag3

9. *${prefix}gelbooru*
Send gelbooru media by specified tags.
Aliases: *gel*
Usage: *${prefix}gelbooru* tag1 tag2 tag3

10. *${prefix}realbooru*
Send realbooru media by specified tags.
Aliases: *rb*
Usage: *${prefix}realbooru* tag1 tag2 tag3
